                ...
                <div className="row">
                    <div className="col-xl-5 col-lg-6 col-md-12 col-sm- col-">
                        <div className="fun-fact-content mb-50 mr-lg-2 mr-xl-0">
                            ...
                            <p>
                            As a frontend developer, I craft user interfaces that seamlessly integrate design and functionality. My systems prioritize intuitive user experiences, leveraging HTML, CSS, and JavaScript to create responsive, visually appealing applications. I specialize in optimizing performance and accessibility, ensuring smooth navigation across devices.
                            </p>
                        </div>
                    </div>
